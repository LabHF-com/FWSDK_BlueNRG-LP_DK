...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\HAL\\HAL_TimeBase\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
HAL_StatusTypeDef HAL_InitTick (uint32_t TickPriority)
{
  ...
  + Prescaler = (HAL_TIM_GetPeriphClock(TIMx)/1000000 - 1) to have a 1MHz TIM1 counter clock.
