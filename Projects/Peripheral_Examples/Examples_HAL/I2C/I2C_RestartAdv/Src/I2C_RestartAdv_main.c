...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\I2C\\I2C_RestartAdv\\MDK-ARM\\{STEVAL-IDB011V1}\\I2C_RestartAdv.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\I2C\\I2C_RestartAdv\\EWARM\\{STEVAL-IDB011V1}\\I2C_RestartAdv.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_HAL\\I2C\\I2C_RestartAdv\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |   ON:the transmission process is complete - Blinking: waiting for User action  |   ON: the reception process is complete  |
...
------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   1stPush:Master starts the transmission process - 2ndPush: Master starts the reception process  |      Not Used      |
