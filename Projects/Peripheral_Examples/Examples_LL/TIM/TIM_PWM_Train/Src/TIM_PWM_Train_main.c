...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\TIM\\TIM_PWM_Train\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
__STATIC_INLINE void  Configure_TIMPWMOutput(void)
{
  ...
  LL_TIM_OC_SetCompareCH4(TIMx, ((LL_TIM_GetAutoReload(TIMx) + 1 ) * (uint32_t)0.25));
