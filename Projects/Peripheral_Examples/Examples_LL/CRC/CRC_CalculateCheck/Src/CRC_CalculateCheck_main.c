...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\CRC\\CRC_CalculateCheck\\MDK-ARM\\{STEVAL-IDB011V1}\\CRC_CalculateCheck.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\\Projects\\Peripheral_Examples\\Examples_LL\\CRC\\CRC_CalculateCheck\\EWARM\\{STEVAL-IDB011V1}\\CRC_CalculateCheck.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\CRC\\CRC_CalculateCheck\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
- \c CRC_CalculateCheck - Release configuration
