...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_StandbyWakeUpTimer\\MDK-ARM\\{STEVAL-IDB011V1}\\RTC_StandbyWakeUpTimer.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_StandbyWakeUpTimer\\EWARM\\{STEVAL-IDB011V1}\\RTC_StandbyWakeUpTimer.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\RTC\\RTC_StandbyWakeUpTimer\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
