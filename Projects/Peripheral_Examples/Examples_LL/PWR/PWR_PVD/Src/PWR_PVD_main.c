...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\PWR\\PWR_PVD\\MDK-ARM\\{STEVAL-IDB011V1}\\PWR_PVD.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\PWR\\PWR_PVD\\EWARM\\{STEVAL-IDB011V1}\\PWR_PVD.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\PWR\\PWR_PVD\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
- \c PWR_PVD - Release configuration
...
-----------------------------------------------------------------------------------------
|     DL1    |                                 Not Used                                 |
|     DL2    |        Off for 2sec indicate that a PVD interrupt was been rised.        |
|     DL3    |  On: the threshold is set to 2.05V - Off: the threshold is set to 2.91V  |
|     DL4    |                                 Not Used                                 |
|     U5     |                                 Not Used                                 |
...
-------------------------------------------------
|      PUSH1     |   Change the PVD threshold.  |
|      PUSH2     |           Not Used           |
