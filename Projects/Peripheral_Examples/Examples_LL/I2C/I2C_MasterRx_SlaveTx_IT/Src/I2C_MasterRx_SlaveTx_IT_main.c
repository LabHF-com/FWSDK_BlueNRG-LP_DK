...
* File Name          : I2C_MasterRx_SlaveTx_IT_main.c
...
/**
 * @file  I2C_MasterRx_SlaveTx_IT/I2C_MasterRx_SlaveTx_IT_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\I2C\\I2C_MasterRx_SlaveTx_IT\\MDK-ARM\\{STEVAL-IDB011V1}\\I2C_MasterRx_SlaveTx_IT.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\I2C\\I2C_MasterRx_SlaveTx_IT\\EWARM\\{STEVAL-IDB011V1}\\I2C_MasterRx_SlaveTx_IT.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\I2C\\I2C_MasterRx_SlaveTx_IT\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |  ON: communication is OK - Fast blinking: wait for user-button press - Slow blinking: error  |  ON: communication is OK - Slow blinking: error  |
...
--------------------------------------------------------------------------------
|      PUSH1     |  Start of the communication by Master  |      Not Used      |
...
The user can choose between Master and Slave through "#define SLAVE_BOARD" in the "I2C_MasterRx_SlaveTx_IT_main.h" file:
...
in the "I2C_MasterRx_SlaveTx_IT_main.h" file:
- Comment "#define SLAVE_BOARD" to select Master board.
- Uncomment "#define SLAVE_BOARD" to select Slave board.
