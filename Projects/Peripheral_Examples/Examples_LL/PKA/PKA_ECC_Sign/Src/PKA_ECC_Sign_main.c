...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Projects\\Peripheral_Examples\\Examples_LL\\PKA\\PKA_ECC_Sign\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
/* Private user code ---------------------------------------------------------*/
  ...
  static uint32_t Public_Key_Out_A[16], Public_Key_Out_B[16]; //, Public_Key_Out_C[16];
