...
|     DL2    |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |
...
|     U5     |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |
