...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_PowerControl\\MDK-ARM\\{STEVAL-IDB011V1}\\BLE_PowerControl.uvprojx</tt> 
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_PowerControl\\EWARM\\{STEVAL-IDB011V1}\\BLE_PowerControl.eww</tt> 
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_PowerControl\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |   LED showing if advertising (blinking) or connected (steady)  |   LED showing if advertising (blinking) or connected (steady)  |
|     DL3    |                            Not Used                            |                            Not Used                            |
|     DL4    |                            Not Used                            |                            Not Used                            |
|     U5     |                  LED signaling path loss zone                  |                  LED signaling path loss zone                  |
