...
REQUIRED(void * const cmd_call_table[]) = {
  ...
  (void *) BLEPLAT_Init,
  (void *) NVMDB_Tick,
  (void *) HAL_RXTX_SEQ_IRQHandler,
  (void *) HAL_CrashHandler,
  (void *) hci_disconnect,
...
#if (EATT_ENABLED == 1)
  (void *) aci_gatt_eatt_srv_init,
  (void *) aci_gatt_eatt_clt_prepare_write_req,
  (void *) aci_gatt_eatt_clt_execute_write_req,
  (void *) aci_gatt_eatt_clt_disc_all_primary_services,
  (void *) aci_gatt_eatt_clt_disc_primary_service_by_uuid,
  (void *) aci_gatt_eatt_clt_find_included_services,
  (void *) aci_gatt_eatt_clt_disc_all_char_of_service,
  (void *) aci_gatt_eatt_clt_disc_char_by_uuid,
  (void *) aci_gatt_eatt_clt_disc_all_char_desc,
  (void *) aci_gatt_eatt_clt_read,
  (void *) aci_gatt_eatt_clt_read_using_char_uuid,
  (void *) aci_gatt_eatt_clt_read_long,
  (void *) aci_gatt_eatt_clt_read_multiple_char_value,
  (void *) aci_gatt_eatt_clt_write_without_resp,
  (void *) aci_gatt_eatt_clt_confirm_indication,
  (void *) aci_gatt_eatt_srv_notify,
  (void *) aci_gatt_eatt_srv_multi_notify,
  (void *) aci_gatt_eatt_clt_read_multiple_var_len_char_value,
#endif  
...
#if (EATT_ENABLED == 1)
  (void *) aci_gatt_eatt_srv_resp,
  (void *) aci_gatt_eatt_clt_write,
  (void *) aci_gatt_eatt_clt_write_long,
  (void *) aci_gatt_eatt_clt_write_char_reliable,
#endif
  ...
  (void *) aci_l2cap_ecfc_connection_req,
  (void *) aci_l2cap_ecfc_connection_resp,
  (void *) aci_l2cap_ecfc_reconfigure_req,
  (void *) aci_l2cap_ecfc_reconfigure_resp,
