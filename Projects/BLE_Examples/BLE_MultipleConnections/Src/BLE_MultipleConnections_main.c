...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\BLE_MultipleConnections\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   Start discovery procedure for connecting to available slave  |  Start discovery procedure for connecting to available master/slave  |   Enter discoverable mode  |
|      PUSH2     |                     Enter discoverable mode                    |                               Not Used                               |          Not Used          |
