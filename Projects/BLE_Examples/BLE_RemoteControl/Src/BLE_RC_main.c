...
/**
 * @file BLE_RC_main.c
 * @brief  This example shows a simple remote control application.
 * 
...
|     U5     |  Led under remote control  |  Led under remote control  |  Led under remote control  |  Led under remote control  |  Led under remote control  |
...
This demo shows how to control a remote device (e.g. to drive an actuator) using BlueNRG-LP.
