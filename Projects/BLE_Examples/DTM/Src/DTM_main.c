...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP DK x.x.x\\Project\\BLE_Examples\\DTM\\WiSE-Studio\\{STEVAL-IDB011V1}</tt> 
  -# Select desired configuration to build
...
@table
|            |        UART        |   UART_WITH_UPDATER  |         SPI        |  SPI_WITH_UPDATER  |
----------------------------------------------------------------------------------------------------
...
------------- 0x10040000
 ...
 - Activation by using PA15 pin (high level at start up).
   - Note: if the PA15 pin is used and is high at start up, this will cause the  DTM Updater starts. So, to avoid this, the support of the DTM Updater can be removed.
