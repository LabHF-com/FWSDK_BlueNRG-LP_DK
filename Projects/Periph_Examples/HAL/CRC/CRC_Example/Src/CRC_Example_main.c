...
|     DL2    |                      ON: CRC is OK - Blinking: CRC error                     |                      ON: CRC is OK - Blinking: CRC error                     |                      ON: CRC is OK - Blinking: CRC error                     |                      ON: CRC is OK - Blinking: CRC error                     |                      ON: CRC is OK - Blinking: CRC error                     |
|     DL3    |   ON: incorrect CRC value is calculated or there is an initialization error  |   ON: incorrect CRC value is calculated or there is an initialization error  |   ON: incorrect CRC value is calculated or there is an initialization error  |   ON: incorrect CRC value is calculated or there is an initialization error  |   ON: incorrect CRC value is calculated or there is an initialization error  |
