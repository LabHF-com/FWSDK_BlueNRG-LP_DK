...
|     DL2    |  Blinking: tick increment is on; Off: tick increment is suspended  |  Blinking: tick increment is on; Off: tick increment is suspended  |  Blinking: tick increment is on; Off: tick increment is suspended  |  Blinking: tick increment is on; Off: tick increment is suspended  |  Blinking: tick increment is on; Off: tick increment is suspended  |
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |  it is used to suspend the tick increment  |  it is used to suspend the tick increment  |  it is used to suspend the tick increment  |  it is used to suspend the tick increment  |  it is used to suspend the tick increment  |
|      PUSH2     |   it is used to resume the tick increment  |   it is used to resume the tick increment  |   it is used to resume the tick increment  |   it is used to resume the tick increment  |   it is used to resume the tick increment  |
