...
|     DL2    |  Blinking: tick increment is on - Toggle: tick increment is suspended  |  Blinking: tick increment is on - Toggle: tick increment is suspended  |  Blinking: tick increment is on - Toggle: tick increment is suspended  |  Blinking: tick increment is on - Toggle: tick increment is suspended  |  Blinking: tick increment is on - Toggle: tick increment is suspended  |
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |  it is used to suspend or resume tick increment  |  it is used to suspend or resume tick increment  |  it is used to suspend or resume tick increment  |  it is used to suspend or resume tick increment  |  it is used to suspend or resume tick increment  |
