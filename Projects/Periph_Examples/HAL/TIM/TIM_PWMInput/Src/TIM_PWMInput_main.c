...
|     DL2    |  toggle: during the Input Capture value  |  toggle: during the Input Capture value  |  toggle: during the Input Capture value  |  toggle: during the Input Capture value  |  toggle: during the Input Capture value  |
