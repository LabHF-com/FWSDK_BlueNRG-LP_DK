...
|     DL2    |  blinking: program is running  |  blinking: program is running  |  blinking: program is running  |  blinking: program is running  |  blinking: program is running  |
|     DL3    |  blinking: program is running  |  blinking: program is running  |  blinking: program is running  |  blinking: program is running  |  blinking: program is running  |
