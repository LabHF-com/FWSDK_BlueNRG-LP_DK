...
|     DL2    |   ON: the transmission/reception process is complete - Blinking: wait for user action  |   ON: the transmission/reception process is complete - Blinking: wait for user action  |   ON: the transmission/reception process is complete - Blinking: wait for user action  |   ON: the transmission/reception process is complete - Blinking: wait for user action  |   ON: the transmission/reception process is complete - Blinking: wait for user action  |
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   Start a Full-Duplex communication  |   Start a Full-Duplex communication  |   Start a Full-Duplex communication  |   Start a Full-Duplex communication  |   Start a Full-Duplex communication  |
