...
|     DL2    |   it toggles each time transmission/reception of 10 characters is completed  |   it toggles each time transmission/reception of 10 characters is completed  |   it toggles each time transmission/reception of 10 characters is completed  |   it toggles each time transmission/reception of 10 characters is completed  |   it toggles each time transmission/reception of 10 characters is completed  |
|     DL3    |          ON when there is an error in transmission/reception process         |          ON when there is an error in transmission/reception process         |          ON when there is an error in transmission/reception process         |          ON when there is an error in transmission/reception process         |          ON when there is an error in transmission/reception process         |
