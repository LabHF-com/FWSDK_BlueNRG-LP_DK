...
|     DL2    |  Toggle: it indicates a change in MCO config - Slow blinking: error  |  Toggle: it indicates a change in MCO config - Slow blinking: error  |  Toggle: it indicates a change in MCO config - Slow blinking: error  |  Toggle: it indicates a change in MCO config - Slow blinking: error  |  Toggle: it indicates a change in MCO config - Slow blinking: error  |
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   Set MCO configuration  |   Set MCO configuration  |   Set MCO configuration  |   Set MCO configuration  |   Set MCO configuration  |
