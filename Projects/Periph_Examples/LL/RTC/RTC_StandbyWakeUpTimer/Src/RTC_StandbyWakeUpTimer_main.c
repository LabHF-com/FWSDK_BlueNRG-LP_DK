...
|     DL2    |   On: system is resumed from standby mode;  fast blinking: wait fpr User push-buton; slow blinking: error  |   On: system is resumed from standby mode;  fast blinking: wait fpr User push-buton; slow blinking: error  |   On: system is resumed from standby mode;  fast blinking: wait fpr User push-buton; slow blinking: error  |   On: system is resumed from standby mode;  fast blinking: wait fpr User push-buton; slow blinking: error  |   On: system is resumed from standby mode;  fast blinking: wait fpr User push-buton; slow blinking: error  |
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   Enter in low power mode  |   Enter in low power mode  |   Enter in low power mode  |   Enter in low power mode  |   Enter in low power mode  |
