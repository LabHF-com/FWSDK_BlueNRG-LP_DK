...
|     DL2    |  Blinking according to TIM period  |  Blinking according to TIM period  |  Blinking according to TIM period  |  Blinking according to TIM period  |  Blinking according to TIM period  |
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |  Modify the timebase period  |  Modify the timebase period  |  Modify the timebase period  |  Modify the timebase period  |  Modify the timebase period  |
