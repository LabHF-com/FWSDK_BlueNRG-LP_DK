...
|     DL2    |        Off for 2sec indicate that a PVD interrupt was been rised.        |        Off for 2sec indicate that a PVD interrupt was been rised.        |        Off for 2sec indicate that a PVD interrupt was been rised.        |        Off for 2sec indicate that a PVD interrupt was been rised.        |        Off for 2sec indicate that a PVD interrupt was been rised.        |
|     DL3    |  On: the threshold is set to 2.05V - Off: the threshold is set to 2.91V  |  On: the threshold is set to 2.05V - Off: the threshold is set to 2.91V  |  On: the threshold is set to 2.05V - Off: the threshold is set to 2.91V  |  On: the threshold is set to 2.05V - Off: the threshold is set to 2.91V  |  On: the threshold is set to 2.05V - Off: the threshold is set to 2.91V  |
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   Change the PVD threshold.  |   Change the PVD threshold.  |   Change the PVD threshold.  |   Change the PVD threshold.  |   Change the PVD threshold.  |
