...
|     DL2    |  Fast blinking: wait User action - Slow blinking: error  |  Fast blinking: wait User action - Slow blinking: error  |  Fast blinking: wait User action - Slow blinking: error  |  Fast blinking: wait User action - Slow blinking: error  |  Fast blinking: wait User action - Slow blinking: error  |
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   start new transmission of complete buffer  |   start new transmission of complete buffer  |   start new transmission of complete buffer  |   start new transmission of complete buffer  |   start new transmission of complete buffer  |
