...
|     DL2    |   Watchdog detect  |   Watchdog detect  |   Watchdog detect  |   Watchdog detect  |   Watchdog detect  |
|     DL3    |      Not Used      |      Not Used      |      Not Used      |      Not Used      |      Not Used      |
|     DL4    |      Not Used      |      Not Used      |      Not Used      |      Not Used      |      Not Used      |
|     U5     |    Activity LED    |    Activity LED    |    Activity LED    |    Activity LED    |    Activity LED    |
